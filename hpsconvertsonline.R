# Prompt for source File
  # New file will be named [SourceFile][_Out.csv]
  # New output file will be saved in same location as source file was found
...
online<-read.csv(SourceFile,header=T)
...
write.table(online,paste0(DirName, "/", BaseName, "_Out.csv"), sep=",", col.names=T, row.names=F)
